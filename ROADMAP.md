...
- [ ] Obtain a separate GPT-6 Astra `ACCEPT` verdict on exact replacement head `9957b2d` before merge. F2, F4 and F6 through F9 are integrated, the full local matrix passes, GitHub reports PR #14 merge-clean and all 18 exact-head checks pass.
